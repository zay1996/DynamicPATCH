...
class InputApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.connectivity_var= tk.IntVar(value=8)  # Set default to 8

        self.connectivity_4 = tk.Radiobutton(self, text="4", variable=self.connectivity_var, value=4)
        self.connectivity_4.grid(row=3, column=1, padx=100, pady=10, sticky='w')

        self.connectivity_8 = tk.Radiobutton(self, text="8", variable=self.connectivity_var, value=8)
        self.connectivity_8.grid(row=3, column=1, padx=150, pady=10, sticky='w')
        ...
        self.study_area_label = tk.Label(self, text="Name of Study Area:")
    ...
    def update_params(self):
        ...
        connectivity = self.connectivity_var.get()  # Get the value from radio buttons
    ...
    def populate_entries(self):
        ...
        # Update the connectivity radio buttons based on the saved value
        if self.params['connectivity'] == 4:
            self.connectivity_var.set(4)  # Set the radio button to 4
        else:
            self.connectivity_var.set(8)  # Set the radio button to 8
...
class MapApp(tk.Toplevel):
    ...
    def setup_ui(self):
        ...
        self.show_transition_check = ttk.Checkbutton(
            self.option_frame, 
            text="Show Transition Pattern Maps", 
            variable=self.show_transition_var,
    ...
    def update_ui_after_analysis(self):
        ...
        if self.mapshow:
            ...
            self.notebook.select(self.result_chart_frame)
